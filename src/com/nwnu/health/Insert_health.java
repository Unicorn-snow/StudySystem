...
import com.nwnu.pojo.Insert;

public class Insert_health extends JPanel implements ActionListener{
    ...
    Insert insert1;  
    String tableName;  
    public Insert_health(){  
        query=new Query();  
        setBackground(Color.orange);  
        query.setTableName("health");  
        a=query.getField();  
